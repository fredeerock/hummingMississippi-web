    ...
    <div id="top" class="header">
      <div class="vert-text">
        ...
        <a href="#about" class="btn btn-default btn-lg">Find Out More</a>
                <a href="http://nexus.cct.lsu.edu:8100" class="btn btn-primary btn-lg">Web Interaction</a>
